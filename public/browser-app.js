/*!jQuery v1.12.4 | (c) jQuery Foundation | jquery.org/license*/ !(function (
    ...
    ;((n.event = {
        ...
        fix: function (a) {
            ...
            ;(h ||
                (this.fixHooks[f] = h =
                    ma.test(f) ? this.mouseHooks
                        : la.test(f) ? this.keyHooks
                        : {}),
            ...
            (c.prototype.show = function () {
                ...
                if (this.hasContent() && this.enabled) {
                    ...
                    if (j) {
                        ...
                        ;((h =
                            "bottom" == h && k.bottom + m > o.bottom ? "top"
